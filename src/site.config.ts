...
const config: SiteConfig = {
  ...
  site: 'https://stefan.grothkopp.com',
  // The name of your site, used in the title and for SEO.
  title: 'Stefan Grothkopp',
  // The description of your site, used for SEO and RSS feed.
  description:
    'A place where I talk about building, coding, tech, personal, writing, AI and more.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Stefan Grothkopp',
  // Keywords for SEO, used in the meta tags.
  tags: ['Building', 'Coding', 'Tech', 'Personal', 'Writing', 'AI'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://www.github.com/grothkopp',
      external: true,
    },
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/grothkopp/',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/grothkopp',
    email: 'blog@xsg.de',
    linkedin: 'https://linkedin.com/in/grothkopp',
